  ...
  return (
    <section className="mt-8 px-4 sm:px-8 flex flex-col sm:flex-row justify-between gap-8">
          ...
          >
            ...
            <div className="flex flex-col items-end">
              <div className="flex items-center gap-2">
                <Button className="text-gray-500" onClick={()=>decreaseQty(item,item.qty)}>-</Button>
                <input
                  type="number"
                  ...
                  readOnly
                />
                <Button className="text-gray-500" onClick={()=>increaseQty(item,item.qty)}>+</Button>
              </div>
      ...
      <div className="w-full sm:w-1/4 rounded-xl bg-white border-2 p-4">
        ...
        <Button className="mt-4 w-full" onClick={checkoutHandler}>Check Out</Button>
      </div>
    </section>
  );
};
